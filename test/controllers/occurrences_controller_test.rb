...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post occurrences_url, params: { occurrence: { catastrophe_code: @occurrence.catastrophe_code, occurrence_code: @occurrence.occurrence_code, person_code: @occurrence.person_code } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { catastrophe_code: @occurrence.catastrophe_code, occurrence_code: @occurrence.occurrence_code, person_code: @occurrence.person_code } }
