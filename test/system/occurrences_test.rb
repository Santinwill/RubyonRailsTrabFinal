...
class OccurrencesTest < ApplicationSystemTestCase
  ...
  test "creating a Occurrence" do
    ...
    fill_in "Catastrophe code", with: @occurrence.catastrophe_code
    fill_in "Occurrence code", with: @occurrence.occurrence_code
    fill_in "Person code", with: @occurrence.person_code
